<template>
    <b-modal id="edit-calendar" ref="edit-calender" size="lg" title="Thay đổi lịch nghỉ" header-bg-variant="primary"
        ...
        <b-form-row>
            <b-col cols="12">
                <b-form-group id="input-group-1" label="Ngày đăng ký:" label-for="date"
                    ...
                    <b-form-input v-model="event.date" id="date" type="text" readonly>
                    </b-form-input>
                </b-form-group>
            </b-col>
            <b-col cols="12" lg="6">
